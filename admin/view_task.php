...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			...
			<div class="col-md-6">
				<dl>
					<dt><b class="border-bottom border-red">Due Date</b></dt>
					<dd><?php echo date("m d,Y",strtotime($due_date)) ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-red">Status</b></dt>
					<dd>
						<?php 
			        	if($status == 0){
					  		echo "<span class='badge badge-info'>Pending</span>";
			        	}elseif($status == 1){
					  		echo "<span class='badge badge-red'>On-Progress</span>";
			        	}elseif($status == 2){
		...
		<div class="row">
			<div class="col-md-12">
				<dl>
				<dt><b class="border-bottom border-red">Description</b></dt>
