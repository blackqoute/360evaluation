...
<div class="text"><br><h2>Subject List <br></h1></div>
 <hr>
<div class="col-lg-12">
	<div class="card card-outline card-danger">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-danger new_subject" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordedanger" id="list">
				<colgroup>
					<col width="5%">
					<col width="15%">
					<col width="30%">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        <a href="javascript:void(0)" data-id='<?php echo $row['id'] ?>' class="btn bg-blue btn-flat manage_subject">
