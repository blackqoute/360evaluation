...
<div class="text"><br><h2>Academic List <br></h1></div>
 <hr>
<div class="col-lg-12">
	<div class="card card-outline card-red">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-danger new_academic" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							...
							<?php else: ?>
								<button type="button" class="btn btn-danger col-sm-4 btn-flat btn-sm px-1 py-0">Yes</button>
							<?php endif; ?>
						</td>
						<td class="text-center">
							<?php if($row['status'] == 0): ?>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        <a href="javascript:void(0)" data-id='<?php echo $row['id'] ?>' class="btn btn-red btn-flat manage_academic">
