...
<div class="text"><br><h2>Criteria List <br></h1></div>
 <hr>
<div class="col-md-12">
						...
						<div class="card card-outline card-danger">
							...
							<div class="card-footer">
								<div class="d-flex justify-content-end w-100">
									<button class="btn btn-sm btn-flat bg-danger mx-1" form="manage-criteria">Save</button>
						...
						<div class="callout callout-danger">
							...
							<div class="d-flex justify-content-between w-100">
								<label for=""><b>Criteria List</b></label>
									<button class="btn btn-sm bg-danger btn-flat bg-gradient-red mx-1" form="order-criteria">Save Order</button>
							</div>
							<hr>
