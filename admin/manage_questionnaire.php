...
?>
<div class="text"><br><h2>Manage Questionnaire <br></h1></div>
 <hr>
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<div class="card card-info card-red">
				...
				<div class="card-footer">
					<div class="d-flex justify-content-end w-100">
						<button class="btn btn-sm btn-danger btn-flat bg-gradient-red mx-1" form="manage-question">Save</button>
			...
			<div class="card card-outline card-danger">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-sm btn-flat btn-danger bg-gradient-red mx-1" id="eval_restrict" type="button">Evaluation Restriction</button>
				...
				<div class="card-body">
					<fieldset class="border border-info p-2 w-100">
					   ...
					   <p>5 = Excellent, 4 = Very Good, 3 = Average, 2 = Below Average, 1 = Poor</p>
					</fieldset>
